...
public class KnoldusBlogPageTest extends Browser {
    @Before
    ...
    public void blogpage() throws InterruptedException {
        ...
        KnoldusBlogPage tabswitch = new KnoldusBlogPage(driver);
        ...
        By minutegap=By.linkText("Studio-DevOps");
                //By.xpath("//*[@id=\"post-132680\"]/div/div[2]/header/h2/a");
        driver.findElement(minutegap).click();


        wait.until(ExpectedConditions.visibilityOfElementLocated(tabswitch.getEmailIdinputbox()));
